...
`logs/pipeline_errors_DNK_deneg.md` — журнал ошибок по клиентам, причины, принятые правки и бэклог (куда зафиксировано в скиллах/валидаторе). Обновлять после каждой калибровки.
